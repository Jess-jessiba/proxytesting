...
name = "resultsplitinch-" + str(today1)
filename = name + ".txt"
f = open(filename, "w")

dict_of_commands = {"Public Splittrial pac": "//astrazeneca.net/global/Folders/Utils/autoprox.exe http://www.bbc.com http://pac.zscalertwo.net/astrazeneca.com/SplitTrial.pac",
                    "Private Splittrail pac": "//astrazeneca.net/global/Folders/Utils/autoprox.exe http://vmanage.astrazeneca.com http://pac.zscalertwo.net/astrazeneca.com/SplitTrial.pac"}
...
powershell_command = 'set-itemproperty -path "hkcu:Software\Microsoft\Windows\CurrentVersion\Internet Settings" -name AutoConfigURL -value "http://pac.zscalertwo.net/astrazeneca.com/SplitTrial.pac" -type string'
...
try:
    ...
    if result.returncode == 0:
        with open(filename, "a") as f:
            file = "\n" + "Following output are for Splittrial pac" + "\n"
            f.write(file)
